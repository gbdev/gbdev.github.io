...
- [Discord Server](https://gbdev.io/chat)
...
- [GB Rom List](https://github.com/gbdev/awesome-gbdev/blob/master/CartridgeList.csv) - Navigable table of every game released with details on their cartridges.
